...
public class UserTrainingProgress implements Serializable {
    ...
    public UserTrainingProgress(UserTrainingProgress value) {
     ...
     */
    public UserTrainingProgress setUserId(String userId) {
        this.userId = userId;
        return this;
    }
     ...
     */
    public UserTrainingProgress setTrainingId(String trainingId) {
        this.trainingId = trainingId;
        return this;
    }
     ...
     */
    public UserTrainingProgress setTrainingCategory(String trainingCategory) {
        this.trainingCategory = trainingCategory;
        return this;
    }
     ...
     */
    public UserTrainingProgress setTrainingChapter(Integer trainingChapter) {
        this.trainingChapter = trainingChapter;
        return this;
    }
     ...
     */
    public UserTrainingProgress setUserAct(Integer userAct) {
        this.userAct = userAct;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final UserTrainingProgress other = (UserTrainingProgress) obj;
        if (this.userId == null) {
        ...
        else if (!this.userAct.equals(other.userAct))
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((this.userAct == null) ? 0 : this.userAct.hashCode());
        return result;
    }
}
